    ...
    class MainClass
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("GetOrdersByProduct:'apple'");
                orders = os.CheckByProduct("apple");
                foreach (Order od in orders)
                    Console.WriteLine(od.ToString());
                ...
                Console.WriteLine("GetOrdersByClient:'Customer1'");
                order = newService.CheckByClient("customer1");
